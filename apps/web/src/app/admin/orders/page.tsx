...
import { Search, Receipt, ShoppingCart } from 'lucide-react';
            ...
            {loading ? (
              ...
              paginatedOrders.map((order) => (
                <TableRow key={order.id}>
                  ...
                  <TableCell className="font-mono text-xs text-slate-500 dark:text-slate-400">{order.razorpayPaymentId}</TableCell>
                  <TableCell>
