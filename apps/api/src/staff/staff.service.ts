      ...
      data: {
        ...
        staffPermission: {
          create: {
            ...
            manageReviews: dto.manageReviews ?? (assignedRole === UserRole.ADMIN),
            manageSocialLinks: dto.manageSocialLinks ?? (assignedRole === UserRole.ADMIN),
  ...
  async updatePermissions(id: string, dto: UpdatePermissionsDto) {
    ...
    return this.prisma.staffPermission.upsert({
      ...
      create: {
        ...
        manageReviews: dto.manageReviews ?? false,
        manageSocialLinks: dto.manageSocialLinks ?? false,
